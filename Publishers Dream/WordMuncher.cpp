...
void WordMuncher::setTreeSructOfWords(tree<string> &thetree) {
    for(int i = 0; i < int(wordstrcut.size()); i++) {
...
void WordMuncher::printFrequencytOfWords() {
    for(int i = 0; i < int(wordstrcutfrequent.size()); i++) {
        ...
        for(int j = 0; j < int(wordstrcutfrequent[i].paratraph.size()); j++) {
            cout << wordstrcutfrequent[i].paratraph[j] << " ";
        }
        cout << endl;
     
        cout << "LINE : ";
        for(int j = 0; j < int(wordstrcutfrequent[i].line.size()); j++) {
...
void WordMuncher::setMostFrequentWords() {
    ...
    for(i = 0; i < int(wordstrcutfrequent.size()); i++) {
        if(newword) {
        ...
        int temp = -1;
        for(j = 0; j < int(wordstrcutmostfrequent.size()); j++) {
...
void WordMuncher::printMostFrequencytOfWords() {
    ...
    for(int i = 0; i < int(wordstrcutmostfrequent.size()); i++) {
        ...
        for(int j = 0; j < int(wordstrcutmostfrequent[i].paratraph.size()); j++) {
            cout << wordstrcutmostfrequent[i].paratraph[j] << " ";
        }
        cout << endl;
        
        cout << "LINE : ";
        for(int j = 0; j < int(wordstrcutmostfrequent[i].line.size()); j++) {
