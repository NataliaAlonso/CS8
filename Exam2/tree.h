...
class tree
{
    public:
        ...
        void rotateWithLeftChild(int &k2);                  // Rotate with left child
        void rotateWithRightChild(int &k1);                 // Rotate with right child
        void doubleWithLeftChild(int &k3);                  // Double rotate with left child
        void doubleWithRightChild(int &k3);                 // Double rotate with right child
...
{
    int k1 = treeVector[k2].left;                                       // Create temp
    treeVector[k2].left = treeVector[k1].right;                         // Swap
    treeVector[k1].right = k2;                                          // Adjust height
...
{
    int k2 = treeVector[k1].right;                                      // Create temp
    treeVector[k1].right = treeVector[k2].left;                         // Swap
    treeVector[k2].left = k1;                                           // Adjust height
...
{
    rotateWithRightChild( treeVector[k3].left );                        // Perform right rotation
    rotateWithLeftChild( k3 );                                          // Perform left rotation
}

template<typename T>
void tree<T>::doubleWithRightChild(int &k3)
{
    rotateWithLeftChild( treeVector[k3].right );                        // Perform left rotation
    rotateWithRightChild( k3 );                                         // Perform right rotation
}
